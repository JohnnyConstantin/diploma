...
// Dependency описывает зависимости, необходимые для инициализации HTTP API.
...
func (a *API) PostRegister(ctx *gin.Context) {
	...
	// Вызываем сервис вместо repo.CreateUser
...
// GetHealthCheck обрабатывает запрос проверки healthcheck.
